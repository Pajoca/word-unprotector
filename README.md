...
\(つまりインスタンス作成だけではiniファイルは新規生成されない。あくまで読み書きの対象となるiniファイルを**指定**しているだけ。\)
...
## 謝辞
ini読み書きクラスのコードは[こちらのWebサイト](https://stackoverflow.com/questions/217902/reading-writing-an-ini-file)で Danny Beckett さんによりパブリックドメインで公開されていたコードを改変したものです。
